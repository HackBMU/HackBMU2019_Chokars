<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yogaknp.aspx.cs" Inherits="yogaknp" %>
...
<body background="yogaandgym/13.jpg" align="center" height="100%" width="100%" >
    <form id="form1" runat="server">
  <h1 style="color:blue; font-family:verdana; text-align:center; background-color:black;">BEST YOGA CLASSES IN KANPUR </h1>
