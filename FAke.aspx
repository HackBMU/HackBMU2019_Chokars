<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FAke.aspx.cs" Inherits="FAke" %>
...
<head runat="server">
  ...
  ====================================================-->
    ...
    <title>Online Tutor : Teacher Profile</title>
                    ...
                    <div class="new1 col-md-2">
                        <ul class="new nav nav-pills nav-stacked well">
                            ...
                            <li><a href="#"><i class="fa fa-sign-out"></i>
                                <asp:Button ID="Button1" runat="server" Text="Logout" OnClick="Button1_Click" /></a></li>
                        </ul>
                    </div>
                    <div class="col-md-10" style="padding: 0px;">
                        <div class="panel">
                            <img class="pic img-circle" src="img/author2.jpg" alt="...">
                            <div class="name"><small>Rahul Verma</small></div>
