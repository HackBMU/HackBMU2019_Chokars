<%@ Page Language="C#" AutoEventWireup="true" CodeFile="underweight.aspx.cs" Inherits="underweight" %>
...
background-color: green;
    clear: left;
    text-align: center;
background-image: url("-123187346.jpg");
}
...
<body>
    ...
    <div class="container">
<header>
   <h1><strong>UNDER-WEIGHT DIET CHART PLAN</strong></h1>
</header>
...
<img src="imagediet/-651675496.jpg" width="500" height="400">
</div>
...
<footer>Copyright © Connect Healthy.com</footer>
