<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="changepass.aspx.cs" Inherits="changepass" %>
         ...
         <div class="col-lg-8 col-md-8 col-sm-8" >
           <div class="contact_form wow fadeInLeft">
              <form action="signin.php" class="submitphoto_form" method="post">
                  ...
                  <asp:TextBox ID="txtusername" runat="server" class="wp-form-control wpcf7-email" name="username" placeholder="Enter New Password" ></asp:TextBox>          
