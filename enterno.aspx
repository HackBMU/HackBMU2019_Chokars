<%@ Page Language="C#" AutoEventWireup="true" CodeFile="enterno.aspx.cs" Inherits="enterno" %>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Enter Mobile No</h2>
              <span></span> 
         ...
         <div class="col-lg-8 col-md-8 col-sm-8" >
           <div class="contact_form wow fadeInLeft">
              <form action="signin.php" class="submitphoto_form" method="post">
                  <asp:TextBox ID="txtusername" runat="server" class="wp-form-control wpcf7-email" name="username" placeholder="Enter Mobile No" ></asp:TextBox>          
               <!--   <asp:TextBox ID="TextBox1" runat="server" class="wp-form-control wpcf7-email" name="username" placeholder="Confirm Password" ></asp:TextBox>  -->        
                <asp:button runat="server" text="Submit" class="wpcf7-submit" name="login" value="Login" />
