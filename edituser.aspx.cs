...
public partial class edituser : System.Web.UI.Page
{
    ...
    {
        string qry = "select * from doctorreg1";
    ...
    protected void grdstudent_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("update doctorreg1 set firstname='" + fname.Text + "',Lastname='" + lastname.Text + "',gender='" + gender.Text + "' where id='" + Convert.ToInt32(id.Text) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
