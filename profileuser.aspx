...
<div class="con container">
	<div class="row well">
        ...
        <div style="padding-left:10%;margin-left:30%;margin-right:10%;">
                <div style="">
...
<!--  <a href="#" class="btn btn-xs btn-primary pull-right" style="margin:10px;"><span class="glyphicon glyphicon-picture"></span> Change cover</a>-->
                ...
                <br />
                <asp:Label ID="txtmsg" runat="server" Height="18px" Width="273px" style="margin-left:20%;" CssClass="auto-style3"></asp:Label>
    	...
    	<div class="panel2">
        	<div class="title2"> <h4>User Information</h4> </div>
               ...
               <div class="form-group">
                	<p><label for="exampleInputfname">First Name :</label>
