<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yogalucknow.aspx.cs" Inherits="yogalucknow" %>
...
<body background="yogaandgym/18.jpg" ><body>
    <form id="form1" runat="server">
   <h1 style="color:blue; font-family:verdana; text-align:center; background-color:black;">BEST YOGA CLASSES IN LUCKNOW </h1>
