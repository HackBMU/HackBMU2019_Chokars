<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="forget.aspx.cs" Inherits="forget" %>
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Forget Password</h2>
              <span></span> 
         ...
         <div class="col-lg-8 col-md-8 col-sm-8" >
           <div class="contact_form wow fadeInLeft">
              ...
              <form action="signin.php" class="submitphoto_form" method="post">
                  <asp:TextBox ID="TextBox1" runat="server" class="wp-form-control wpcf7-email" name="username" placeholder="enter Mobile No" ></asp:TextBox>          
                 
                <asp:button runat="server" text="Send OTP" class="wpcf7-submit" name="login" value="Login" OnClick="Unnamed_Click" />
