...
<div class="con container">
	<div class="row well">
		<div class="new1 col-md-2">
    	   <ul class="new nav nav-pills nav-stacked well">
             ...
             <li><a href="bmi.aspx"><i class="fa fa-user"></i>Diet Plan</a></li>
                 <li><a href="yogaandgym.aspx"><i class="fa fa-user"></i>Yoga and Gym Maintaining Fitness Center       
                 <li><a href="chat.aspx"><i class="fa fa-user"></i>Discussion Forum</a></li>
               
          <li><a href="search.aspx"><i class="fa fa-user"></i>Find our Yoga and Gym center</a></li>
        ...
        <div style="padding-left:10%;margin-left:30%;margin-right:30%;">
                <div style="">
                 <!--   <img class="pic img-circle" src="img/author.jpg" alt="...">-->
                      <asp:Image ID="Image3" runat="server" Height="179px" Width="297px"/>
...
<!--  <a href="#" class="btn btn-xs btn-primary pull-right" style="margin:10px;"><span class="glyphicon glyphicon-picture"></span> Change cover</a>-->
                ...
                <br />
                <asp:Label ID="txtmsg" runat="server" Height="18px" Width="273px" style="margin-left:60%;" CssClass="auto-style3"></asp:Label>
