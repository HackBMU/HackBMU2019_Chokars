<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgetotp.aspx.cs" Inherits="forgetotp" %>
         ...
         <div class="col-lg-8 col-md-8 col-sm-8" >
           <div class="contact_form wow fadeInLeft">
                <asp:Label ID="Label2" runat="server"></asp:Label>
                  ...
                  <asp:TextBox ID="txtusername" runat="server" class="wp-form-control wpcf7-email" name="username" placeholder="Enter the OTP" ></asp:TextBox>          
                 
                <asp:button runat="server" text="Verify" class="wpcf7-submit" name="login" value="Login" />
