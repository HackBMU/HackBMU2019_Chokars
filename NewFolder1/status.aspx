      ...
      <div class="row">
        ...
        <!--  <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Status Details</div>
            </div>
          ...
          <asp:GridView ID="grdstudent" runat="server" AutoGenerateColumns="false" width="100%" OnRowEditing="grdstudent_RowEditing" OnRowUpdating="grdstudent_RowUpdating" OnRowDeleting="grdstudent_RowDeleting">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="User mail">
                        <ItemTemplate>
                            <asp:Label ID="lblfirstname" runat="server" Text='<%#Bind("user_email") %>'></asp:Label>
                        </ItemTemplate>
                       
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Doctor mail">
                        <ItemTemplate>
                            <asp:Label ID="lbllastname" runat="server" Text='<%#Bind("doc_email") %>'></asp:Label>
                        </ItemTemplate>
                        
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Status">
                        <ItemTemplate>
                            <asp:Label ID="lblemail" runat="server" Text='<%#Bind("status") %>'></asp:Label>
                        </ItemTemplate>
                      
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Request Sent">
                        <ItemTemplate>
                            <asp:Label ID="lblgender" runat="server" Text='<%#Bind("isRequestSent") %>'></asp:Label>
                        </ItemTemplate>
                      
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Request Accepted">
                        <ItemTemplate>
                            <asp:Label ID="lblgender" runat="server" Text='<%#Bind("isRequestAccepted") %>'></asp:Label>
                        </ItemTemplate>
                     </asp:TemplateField>
