          ...
          <asp:GridView ID="grdstudent" runat="server" AutoGenerateColumns="false" width="100%" OnRowEditing="grdstudent_RowEditing" OnRowUpdating="grdstudent_RowUpdating" OnRowDeleting="grdstudent_RowDeleting">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Password">
                        <ItemTemplate>
                            <asp:Label ID="lblgender" runat="server" Text='<%#Bind("password") %>'></asp:Label>
                        </ItemTemplate>
                      
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Date of Birth">
                        <ItemTemplate>
                            <asp:Label ID="lblgender" runat="server" Text='<%#Bind("dob") %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Specilization">
                        <ItemTemplate>
                            <asp:Label ID="lblgender" runat="server" Text='<%#Bind("specilization") %>'></asp:Label>
                        </ItemTemplate>
