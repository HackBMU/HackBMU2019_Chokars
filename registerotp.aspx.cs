...
public partial class registerotp : System.Web.UI.Page
{
    ...
    protected void Unnamed_Click(object sender, EventArgs e)
    {
        ...
        String myquery = "Select * from userreg1 where email='" + Request.QueryString["email"] + "'";
    ...
    {
        String mycon = "Data Source=DESKTOP-JNIJ4IS\\SQLEXPRESS;Initial Catalog=fitness;Integrated Security=True";
        String updatedata = "Update userreg1 set status='Verified' where email='" + Request.QueryString["email"] + "'";
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
